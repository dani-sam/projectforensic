...
def addCase():
    if 'submit' in request.form:
        ...
        q1="insert into cases values(null,'%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')"%(session['police_id'],date,time,place,caseType,path,latitude,longitude,detailOfEvents,summary,reportOfficer)
        insert(q1)
