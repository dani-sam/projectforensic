...
"use strict";
module.exports = JSON.parse('{"name":"@truffle/core","description":"Core code for Truffle command line tool","license":"MIT","author":"consensys.net","homepage":"https://github.com/trufflesuite/truffle#readme","repository":{"type":"git","url":"https://github.com/trufflesuite/truffle.git","directory":"packages/core"},"bugs":{"url":"https://github.com/trufflesuite/truffle/issues"},"version":"5.5.20","bin":{"truffle":"./cli.js","truffle-exec":"./exec.js"},"scripts":{"prepare":"exit 0","test":"mocha ./test/** ./test/**/*"},"dependencies":{"@truffle/artifactor":"^4.0.159","@truffle/box":"^2.1.51","@truffle/codec":"^0.13.2","@truffle/compile-common":"^0.7.32","@truffle/compile-solidity":"^6.0.33","@truffle/config":"^1.3.31","@truffle/contract":"^4.5.15","@truffle/dashboard":"^0.1.8","@truffle/debug-utils":"^6.0.27","@truffle/debugger":"^10.0.16","@truffle/decoder":"^5.2.18","@truffle/deployer":"^3.2.86","@truffle/environment":"^0.2.113","@truffle/error":"^0.1.0","@truffle/expect":"^0.1.1","@truffle/fetch-and-compile":"^0.5.8","@truffle/interface-adapter":"^0.5.18","@truffle/migrate":"^3.3.0","@truffle/plugins":"^0.2.7","@truffle/preserve":"^0.2.7","@truffle/promise-tracker":"^0.1.0","@truffle/provider":"^0.2.56","@truffle/provisioner":"^0.2.54","@truffle/require":"^2.0.100","@truffle/resolver":"^9.0.6","@truffle/source-fetcher":"^1.0.9","@truffle/spinners":"^0.2.0","@truffle/workflow-compile":"^4.0.23","address":"^1.1.2","chai":"^4.2.0","colors":"1.4.0","command-exists":"^1.2.8","conf":"^10.0.2","debug":"^4.3.1","del":"^2.2.0","ethereum-cryptography":"1.0.3","ethereumjs-wallet":"^1.0.1","ethpm":"0.0.19","ethpm-registry":"0.1.0-next.3","fs-extra":"^9.1.0","ganache":"7.2.0","get-port":"^5.1.1","get-random-values":"^1.2.2","glob":"^7.1.6","inquirer":"8.2.2","js-interpreter":"2.2.0","lodash":"^4.17.21","mocha":"9.2.2","node-emoji":"^1.8.1","original-require":"^1.0.1","sane":"^4.0.2","semver":"^7.3.4","source-map-support":"^0.5.19","spawn-args":"0.2.0","tmp":"^0.2.1","universal-analytics":"^0.4.17","web3":"1.7.4","web3-utils":"1.7.4","xregexp":"^4.2.4","yargs":"^13.3.0"},"devDependencies":{"@truffle/blockchain-utils":"^0.1.3","app-module-path":"^2.2.0","chai-as-promised":"^7.1.1","memorystream":"^0.3.1","sinon":"^9.0.2"},"publishConfig":{"access":"public"},"authors":[{"name":"Tim Coulter","email":"tim@trufflesuite.com","url":"https://github.com/tcoulter"}],"namespace":"consensys","gitHead":"d30ce8fcd3a84044c04ac7466d4b3be2b4e8ae48"}');
...
/******/ 		var __webpack_exports__ = __webpack_require__.O(undefined, [5158,3275,325,4847,6674,5674,9669,8516,5313,406,1324,2110,2765,5358,3983,7091,6345,1111,4976,3947,6133,246,4914,6062,4079,8419,5217,7986,3099,6642,6224,553,4273,4889,3459,458,2422], () => (__webpack_require__(489244)))
